...
import generateFallbackForgotPasswordUrl from '../../utils/generateFallbackForgotPasswordUrl';
...
export default function SignInBox(): JSX.Element {
  ...
  const forgotPasswordFallbackUrl = generateFallbackForgotPasswordUrl(searchParams);
