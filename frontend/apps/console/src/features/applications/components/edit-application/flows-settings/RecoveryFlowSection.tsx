 ...
 */
export default function RecoveryFlowSection({application, editedApp, onFieldChange}: RecoveryFlowSectionProps) {
      ...
      <Autocomplete
        ...
        renderInput={(params) => (
          <TextField
            ...
            helperText={t('applications:edit.flows.recoveryFlow.hint')}
            InputProps={{
              ...params.InputProps,
              endAdornment: (
                <>
