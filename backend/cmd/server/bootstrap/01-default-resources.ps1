...
if (-not $CONSOLE_RECOVERY_FLOW_ID) {
    Log-Error "Console recovery flow ID not found, cannot create Console application"
    Log-Error "Make sure flows/apps/console/recovery_flow_console.json exists"
    exit 1
}
